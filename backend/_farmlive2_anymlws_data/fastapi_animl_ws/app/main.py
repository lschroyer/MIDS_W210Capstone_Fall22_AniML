...
@app.get("/", response_class=HTMLResponse)
async def home(request: Request):
    data = openfile("index.html")
    return templates.TemplateResponse("page.html", context={"request": request, "data": data})


@app.get("/page/detection", response_class=HTMLResponse)
async def detection(request: Request):
    data = openfile("index.html")
    return templates.TemplateResponse("page.html", context={"request": request, "data": data})

@app.get("/page/training", response_class=HTMLResponse)
async def detection(request: Request):
    data = openfile("training.html")
    return templates.TemplateResponse("page.html", context={"request": request, "data": data})
